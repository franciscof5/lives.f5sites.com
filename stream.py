#!/usr/bin/env python3
"""
stream.py — Núcleo da transmissão 24/7: descoberta de vídeos,
geração/cache de bumpers, feeder (FIFO) e publisher (RTMP).

Não roda sozinho normalmente -- é importado por live.py, que
também sobe a API (api.py) e chama stream.run().
"""
